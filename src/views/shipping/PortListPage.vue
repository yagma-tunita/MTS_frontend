  ...
  <div class="port-list-page">
    <el-card>
      ...
      <el-table :data="list" border stripe v-loading="loading">
        <el-table-column prop="port_id" label="ID" width="60" /><el-table-column prop="port_name" label="港口名称" min-width="150" />
        <el-table-column prop="port_code" label="港口代码" width="120" /><el-table-column prop="port_type" label="类型" width="100" />
        <el-table-column label="操作" width="100"><template #default="{ row }"><el-button size="small" @click="$router.push(`/shipping/port/detail/${row.port_id}`)">详情</el-button></template></el-table-column>
      </el-table>
