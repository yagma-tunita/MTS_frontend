<template>
  <div class="layout">
    <div class="sidebar">
      ...
      <el-menu :default-active="activeMenu" router background-color="#001529" text-color="rgba(255,255,255,0.65)" active-text-color="#fff">
        ...
        <el-sub-menu index="basic">
          ...
          <el-menu-item index="/shipping/port/list">港口信息</el-menu-item>
          <el-menu-item index="/shipping/vessel/list">船舶信息</el-menu-item>
          <el-menu-item index="/shipping/line/list">航线信息</el-menu-item>
        </el-sub-menu>
        <el-menu-item index="/shipping/report"><el-icon><DataAnalysis /></el-icon><span>统计报表</span></el-menu-item>
      </el-menu>
      ...
      <div class="header">
        <div class="header-left">
          <el-breadcrumb separator=">">
            <el-breadcrumb-item :to="{ path: '/shipping/dashboard' }">首页</el-breadcrumb-item>
    ...
    <PasswordChangeDialog :visible="passwordDialogVisible" role="shipping" :user-id="userIdStr" @close="passwordDialogVisible = false" />
  </div>
</template>
...
import { Ship, Odometer, List, DataBoard, MapLocation, DataAnalysis, ArrowDown, Bell, Timer } from '@element-plus/icons-vue'
...
const activeMenu = computed(() => {
  ...
  if (path.startsWith('/shipping/order/')) return '/shipping/order/list'
