<template>
  <div class="admin-list-page">
    <el-card>
      <template #header><span>管理员列表</span><el-button size="small" type="primary" style="float: right" @click="openCreate">创建管理员</el-button></template>
...
const loading = ref(false); const creating = ref(false); const list = ref([]); const meta = ref({})
const query = reactive({ page: 1, page_size: 10 }); const createVisible = ref(false)
